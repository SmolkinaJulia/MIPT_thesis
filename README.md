...
|Тема НИР	                    |Разработка алгоритма классификации действий на зображениях (Обучение эмбеддингов в задаче для нейросетевых моделей классификации) |Возможны изменения или дополнения 
